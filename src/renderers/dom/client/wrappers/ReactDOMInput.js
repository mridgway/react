 ...
 */
function ReactDOMInput(props, context) {
  this.props = props;
...
ReactDOMInput.displayName = 'ReactDOMInput';
ReactDOMInput.propTypes = LinkedValueUtils.Mixin.propTypes;

assign(
  ReactDOMInput.prototype,
  {
  ...
  ReactClassMixin,
  {
    ...
    componentDidMount: function() {
      AutoFocusMixin.componentDidMount.apply(this, arguments);
